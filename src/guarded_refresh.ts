...
const APPROVED_ORIGIN = "https://technocore.chat";
const GUARDED_RUNTIME_ROOT = "/var/db/flop-agent-refresh";
const MIN_REFRESH_INTERVAL_MS = 5 * 24 * 60 * 60 * 1_000;
const GUARDED_RECEIPT_ID = "technocore-refresh-guarded";
